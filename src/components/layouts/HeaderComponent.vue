<template>
    <div class="flex items-center justify-between md:justify-end p-3 md:p-8">
        <button class="w-8 h-8 flex justify-center items-center md:hidden" @click="applicationStore.menuTrigger"><Icon type="menu"></Icon></button>
        <div class="flex items-center">
            <button class="w-8 h-8 flex justify-center items-center rounded-full" @click="toggleDark()" type="button">
                <span v-if="!isDark">
                ...
                <div class="">
                    <div class="dropdown inline-block relative">
                        <button class="font-semibold py-2 px-4 rounded inline-flex items-center">
                            <span class="mr-2">MD Kauser Alom</span>
                            <svg class="fill-current h-6 w-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z"/> </svg>
                        </button>
                        <ul class="dropdown-menu absolute hidden text-gray-700 bg-white dark:bg-black rounded w-full">
                            <li><a class="rounded-t hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" href="#">Go profile</a></li>
                            <li><a class="hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" href="#">Setting</a></li>
                            <hr class=" border-gray-300 dark:border-gray-600">
                            <li><a class="rounded-b hover:bg-red-400 text-red-500 hover:text-white py-2 px-4 block whitespace-no-wrap" href="#">Logout</a></li>
                        </ul>
                    </div>
                </div>
            </div>
